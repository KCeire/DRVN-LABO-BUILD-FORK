...
import { BusterSwapInterface } from "../../swap/components/buster-club-interface";
      ...
      <div className="bg-gray-950 rounded-xl border border-gray-700 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 relative z-[999999]">
          <BusterSwapInterface
            ...
            // TODO: Add props to restrict tokens to only ETH and BSTR
            // This will require modifying the SwapInterface to accept token restrictions
          />
        </div>
      </div>
    </div>
