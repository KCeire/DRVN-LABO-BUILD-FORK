...
import { BUSTER_TOKENS } from "../types/buster-swap";
...
export function BusterSwapInterface({
  ...
  const swappableTokens = Object.values(BUSTER_TOKENS);
        ...
        <div className="relative">
          ...
          >
            ...
            <SwapAmountInput
              ...
              token={BUSTER_TOKENS.ETH} // Default to ETH
              type="from"
            />
            ...
            <SwapAmountInput
              label="You Receive"
              swappableTokens={swappableTokens}
              token={BUSTER_TOKENS.BSTR} // Default to BSTR
              type="to"
            />
