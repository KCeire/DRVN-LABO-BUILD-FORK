 ...
 */
contract DRVNTitanium is ERC1155, ERC1155Supply, ERC1155Burnable, ERC2981, Ownable, Pausable, ReentrancyGuard {
    ...
    // ——— Mint config ———
    uint256 public immutable MAX_SUPPLY; // cap for ID 2
